    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="${pageContext.request.contextPath}/roomManagement?view=create" class="btn btn-primary">
                            ...
                            <tbody>
                                <c:forEach var="room" items="${rooms}">
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${not empty room.roomType}">
                                                <fmt:formatNumber value="${room.roomType.basePrice}" type="currency" currencySymbol="₫" />
                                            </c:if>
                                        </td>
                                        <td>
                                            <c:choose>
                        ...
                        <nav aria-label="Page navigation" class="mt-4">
                            <ul class="pagination justify-content-center">
                                ...
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/roomManagement?view=list&page=${currentPage - 1}">
                                ...
                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${currentPage == i ? 'active' : ''}">
                                        <a class="page-link" href="${pageContext.request.contextPath}/roomManagement?view=list&page=${i}">
                                            ${i}
                                        </a>
                                    </li>
                                </c:forEach>
