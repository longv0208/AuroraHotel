...
<c:set var="pageTitle" value="Báo Cáo Lưu Trú - Aurora Hotel" scope="request"/>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <form method="get" action="${pageContext.request.contextPath}/report">
                <input type="hidden" name="view" value="occupancy">
                <div class="row">
                    <div class="col-md-3">
        ...
        <div class="col">
            <div class="card bg-warning text-dark">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="card-title">${occupiedRooms}</h4>
                            <p class="card-text">Phòng Đã Thuê</p>
                        </div>
                        <div class="align-self-center">
        ...
        <div class="col">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="card-title">${availableRooms}</h4>
                            <p class="card-text">Phòng Trống</p>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <c:forEach var="occupancy" items="${occupancyData}">
                                    <tr>
                                        <td><fmt:formatDate value="${occupancy.date}" pattern="dd/MM/yyyy"/></td>
