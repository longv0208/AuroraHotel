...
<c:set var="pageTitle" value="Thanh Toán Cọc - Aurora Hotel" scope="request"/>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/payment">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="<fmt:formatNumber value="${depositAmount}" type="currency" currencySymbol="₫"/>" readonly>
                            </div>
                        </div>
